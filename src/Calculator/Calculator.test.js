...
describe('Calculator', () => {
  ...
  it('should render the Display Component', () => {
    expect(wrapper.containsMatchingElement(
      ...
      // on accéde aux variables d'état et aux méthodes de Calculatoren utilisant la instanceméthode sur l' wrapperobjet
    )).toEqual(true);
  });
  ...
  // containsAllMatchingElementsprend un tableau d'éléments et retourne truesi tous les éléments se trouvent dans l'arborescence DOM.
});
